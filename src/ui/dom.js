...
const elements = {
  ...
  timeFluxQuickCustomSpeed: document.getElementById("timeFluxQuickCustomSpeed"),
  timeFluxQuickCustomSpeedButton: document.getElementById("timeFluxQuickCustomSpeedButton"),
  ...
  timeFluxCustomSpeedApply: document.getElementById("timeFluxCustomSpeedApply"),
  timeFluxCustomSpeedApplyValue: document.getElementById("timeFluxCustomSpeedApplyValue"),
  timeFluxSpeedButtons: Array.from(document.querySelectorAll(".time-flux-speed")),
  timeFluxCustomSpeedButtons: Array.from(document.querySelectorAll(".time-flux-custom-speed-button")),
