...
const TEXT = {
  ja: {
    ...
    updateTitle: "0.1.2 アップデート",
    updateSummary: "実績報酬と核増幅プレビューの表示不整合を修正しました。",
    updateResetDock: "初回Infinity直前の高速周回で、余分な核到達分が集計されないようにしました。",
    updateCanvas: "複数コア時の高速バッチ処理も時系列順の進行と一致するようにしました。",
    updateModalNote: "セーブデータの互換性は維持されています。",
    updateClose: "閉じる",
    under10ms: "10ミリ秒未満",
    secondsUnit: "秒",
  ...
  en: {
    ...
    updateTitle: "Version 0.1.2",
    updateSummary: "Fixed achievement reward labels and the Core Boost preview after IU 7-1.",
    updateResetDock: "Prevented high-speed first-Infinity frames from counting extra core hits.",
    updateCanvas: "Kept multi-core high-speed batching aligned with chronological progression.",
    updateModalNote: "Save compatibility is unchanged.",
    updateClose: "Close",
    under10ms: "<10 ms",
    secondsUnit: "s",
    millisecondsUnit: "ms",
