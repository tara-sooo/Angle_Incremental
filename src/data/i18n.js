...
const TEXT = {
  ja: {
    ...
    updateTitle: "0.2.4 アップデート",
    updateSummary: "核増幅の獲得指数プレビューを修正しました。",
    updateResetDock: "IC5報酬を、次の核増幅プレビューにも反映するようにしました。",
    updateCanvas: "獲得指数のプレビューが現在値より低く見えることがなくなりました。",
    updateModalNote: "実際の効果とセーブデータ形式は変更していません。",
    updateClose: "閉じる",
    under10ms: "10ミリ秒未満",
    secondsUnit: "秒",
  ...
  en: {
    ...
    updateTitle: "Version 0.2.4",
    updateSummary: "Fixed the Core Boost gain exponent preview.",
    updateResetDock: "The IC5 reward is now included in the next Core Boost preview.",
    updateCanvas: "The gain exponent preview no longer appears lower than the current value.",
    updateModalNote: "Actual effects and save data compatibility are unchanged.",
    updateClose: "Close",
    under10ms: "<10 ms",
    secondsUnit: "s",
    millisecondsUnit: "ms",
