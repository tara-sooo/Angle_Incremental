...
const TEXT = {
  ja: {
    ...
    updateTitle: "0.3.1 アップデート",
    updateSummary: "IU11のソフトキャップを強化し、過剰なIPとInfinity回数を補正しました。",
    updateResetDock: "IU11-1とIU11-2の伸びすぎを抑えました。",
    updateCanvas: "過剰に増えたIPは最大2000万IP、Infinity回数は最大30000回に補正されます。",
    updateModalNote: "セーブデータ形式は変更していません。",
    updateClose: "閉じる",
    under10ms: "10ミリ秒未満",
    secondsUnit: "秒",
  ...
  en: {
    ...
    updateTitle: "Version 0.3.1",
    updateSummary: "Strengthened the IU11 softcaps and capped excessive IP and Infinity count.",
    updateResetDock: "Reduced runaway growth from IU 11-1 and IU 11-2.",
    updateCanvas: "Excessive IP is capped at 20000000 IP, and Infinity count is capped at 30000.",
    updateModalNote: "Save data compatibility is unchanged.",
    updateClose: "Close",
    under10ms: "<10 ms",
    secondsUnit: "s",
    millisecondsUnit: "ms",
