...
const TEXT = {
  ja: {
    ...
    updateTitle: "0.3.0 アップデート",
    updateSummary: "新しいInfinity Upgrade 11-1/11-2を追加しました。",
    updateResetDock: "Break Infinite CapをInfinity画面上部へ移動しました。",
    updateCanvas: "IU8-1とIU9-1の配置を中央に揃えました。",
  ...
  en: {
    ...
    updateTitle: "Version 0.3.0",
    updateSummary: "Added new Infinity Upgrades 11-1 and 11-2.",
    updateResetDock: "Moved Break Infinite Cap to the top of the Infinity screen.",
    updateCanvas: "Centered the IU 8-1 and IU 9-1 rows.",
