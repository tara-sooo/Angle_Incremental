...
const TEXT = {
  ja: {
    ...
    updateTitle: "0.4.0 アップデート",
    updateSummary: "Infinity後半の自動化、実績報酬、IU10以降のバランスを更新しました。",
    updateResetDock: "IU8-1はInfinity自動化専用になり、実績19でGR/CB自動化を解放します。",
    updateCanvas: "IU11-1とIU11-2は明確な上限を持ち、IPとInfinity回数のhotfix上限は撤廃されました。",
    updateModalNote: "セーブデータ形式を更新し、巨大なIP残高を正確に保存します。",
    updateClose: "閉じる",
    under10ms: "10ミリ秒未満",
    secondsUnit: "秒",
  ...
  en: {
    ...
    updateTitle: "Version 0.4.0",
    updateSummary: "Updated late-Infinity automation, achievement rewards, and IU10+ balance.",
    updateResetDock: "IU 8-1 now unlocks Infinity automation only, while achievement 19 unlocks GR/CB automation.",
    updateCanvas: "IU 11-1 and IU 11-2 now have clear caps, and the hotfix IP/Infinity caps were removed.",
    updateModalNote: "The save format was updated to preserve very large IP balances exactly.",
    updateClose: "Close",
    under10ms: "<10 ms",
    secondsUnit: "s",
    millisecondsUnit: "ms",
