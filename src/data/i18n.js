...
const TEXT = {
  ja: {
    ...
    updateTitle: "0.6.0 アップデート",
    updateSummary: "Infinity後半の進行とInfinity Upgrade画面を更新しました。",
    updateResetDock: "IC8の内容と報酬を再設計し、IU 12-1を追加しました。",
    updateCanvas: "Infinity Upgrade画面とInfinity回数表示を改善しました。",
    updateModalNote: "セーブデータ形式は0.5.xから変更ありません。",
    updateClose: "閉じる",
    under10ms: "10ミリ秒未満",
    secondsUnit: "秒",
  ...
  en: {
    ...
    updateTitle: "Version 0.6.0",
    updateSummary: "Updated late-Infinity progression and the Infinity Upgrade screen.",
    updateResetDock: "Redesigned IC8's restriction and reward, and added IU 12-1.",
    updateCanvas: "Improved the Infinity Upgrade screen and Infinity count display.",
    updateModalNote: "The save format is unchanged from 0.5.x.",
    updateClose: "Close",
    under10ms: "<10 ms",
    secondsUnit: "s",
    millisecondsUnit: "ms",
