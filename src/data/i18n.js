...
const TEXT = {
  ja: {
    ...
    updateTitle: "0.1.1 アップデート",
    updateSummary: "高スコア帯の動作が重くなる問題を修正しました。",
    updateResetDock: "高速周回時の大量の頂点通過処理を軽量化しました。",
    updateCanvas: "1e50以降の進行で画面が固まりにくくなるようにしました。",
  ...
  en: {
    ...
    updateTitle: "Version 0.1.1",
    updateSummary: "Fixed severe slowdown in high-score progression.",
    updateResetDock: "Reduced the cost of processing large vertex batches at high lap speeds.",
    updateCanvas: "Progression after 1e50 should no longer freeze the page as easily.",
