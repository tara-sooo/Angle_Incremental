...
const TEXT = {
  ja: {
    ...
    updateSummary: "Infinity Upgradeと実績を拡張しました。",
    updateResetDock: "Infinity Upgrade 5〜7を追加し、後半進行用の新しい強化を実装しました。",
    updateCanvas: "実績を14個から25個へ拡張しました。IC3クリアでIP獲得量が×2、所持100 IPでGenerationのコスト倍率がさらに×0.98されます。",
  ...
  en: {
    ...
    updateSummary: "Infinity Upgrades and Achievements have expanded.",
    updateResetDock: "Added Infinity Upgrades 5–7, with new upgrades for late-game progression.",
    updateCanvas: "Expanded Achievements from 14 to 25. Clearing IC3 now grants ×2 IP, while holding 100 IP adds a ×0.98 Generation cost factor.",
