...
const TEXT = {
  ja: {
    ...
    updateTitle: "0.2.3 アップデート",
    updateSummary: "IC5と初回Infinity直前の安定性を修正しました。",
    updateResetDock: "IC5中はIU 10-1の開始時CB2つが無効になります。",
    updateCanvas: "巨大な初回Infinity直前の処理で進行が止まらないようにしました。",
    updateModalNote: "初回Infinity到達時に余分なIPを得ない挙動を保ちました。",
    updateClose: "閉じる",
    under10ms: "10ミリ秒未満",
    secondsUnit: "秒",
  ...
  en: {
    ...
    updateTitle: "Version 0.2.3",
    updateSummary: "Fixed IC5 behavior and first-Infinity stability.",
    updateResetDock: "IU 10-1 starting Core Boosts are disabled during IC5.",
    updateCanvas: "Huge first-Infinity batches no longer drop progress.",
    updateModalNote: "The first Infinity still avoids granting extra post-threshold IP.",
    updateClose: "Close",
    under10ms: "<10 ms",
    secondsUnit: "s",
    millisecondsUnit: "ms",
