...
const TEXT = {
  ja: {
    ...
    autoGenerationMode: "GR条件",
    autoGenerationModeOr: "どちらか",
    autoGenerationModeAnd: "両方",
    autoGenerationScoreThreshold: "GRスコア改善(%)",
    autoGenerationCostThreshold: "GRコスト改善(%)",
    ...
    updateTitle: "0.2.0 アップデート",
    updateSummary: "新しいInfinity Upgradeを追加しました。",
    updateResetDock: "IU 8-1から10-2までの新しい強化で、Infinity後半の進行が広がります。",
    updateCanvas: "IU 8-1でGeneration、Core Boost、Infinityの自動化を解放できます。",
    updateModalNote: "IU 9-1以降ではIP獲得式、初期Core Boost、スコア強化が追加されます。",
    updateClose: "閉じる",
    under10ms: "10ミリ秒未満",
    secondsUnit: "秒",
  ...
  en: {
    ...
    autoGenerationMode: "GR condition",
    autoGenerationModeOr: "Either",
    autoGenerationModeAnd: "Both",
    autoGenerationScoreThreshold: "GR score improve (%)",
    autoGenerationCostThreshold: "GR cost improve (%)",
    ...
    updateTitle: "Version 0.2.0",
    updateSummary: "Added new Infinity Upgrades.",
    updateResetDock: "IU 8-1 through 10-2 expand late-Infinity progression.",
    updateCanvas: "IU 8-1 unlocks Generation, Core Boost, and Infinity automation.",
    updateModalNote: "IU 9-1 and later add a new IP formula, starting Core Boosts, and score scaling.",
    updateClose: "Close",
    under10ms: "<10 ms",
    secondsUnit: "s",
    millisecondsUnit: "ms",
