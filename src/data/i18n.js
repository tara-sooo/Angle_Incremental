...
const TEXT = {
  ja: {
    ...
    updateTitle: "0.5.0 アップデート",
    updateSummary: "実績、ニュース、上部バー表示を更新しました。",
    updateResetDock: "実績を30個に拡張し、既存セーブの実績進行を移行します。",
    updateCanvas: "ニュース欄と、ニュース・資源量・進捗状況などを選べる上部バー設定を追加しました。",
    updateModalNote: "自動で流れるニュースがスクリーンリーダーに繰り返し通知されないようにしました。",
    updateClose: "閉じる",
    under10ms: "10ミリ秒未満",
    secondsUnit: "秒",
  ...
  en: {
    ...
    updateTitle: "Version 0.5.0",
    updateSummary: "Updated achievements, news, and top-bar display options.",
    updateResetDock: "Achievements now total 30, with existing save progress migrated.",
    updateCanvas: "Added a news ticker and configurable top bar modes for news, resources, progress, and more.",
    updateModalNote: "Auto-rotating news no longer repeats announcements to screen readers.",
    updateClose: "Close",
    under10ms: "<10 ms",
    secondsUnit: "s",
    millisecondsUnit: "ms",
