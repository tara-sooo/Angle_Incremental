...
const TEXT = {
  ja: {
    ...
    updateTitle: "0.5.1 アップデート",
    updateSummary: "上部バーまわりの表示を調整しました。",
    updateResetDock: "FPS表示が上部バーに重ならないようにしました。",
    updateCanvas: "ニュース本文の切り替えをスクロール完了タイミングに同期しました。",
    updateModalNote: "セーブデータ形式は0.5.0から変更ありません。",
    updateClose: "閉じる",
    under10ms: "10ミリ秒未満",
    secondsUnit: "秒",
  ...
  en: {
    ...
    updateTitle: "Version 0.5.1",
    updateSummary: "Adjusted top-bar display behavior.",
    updateResetDock: "The FPS counter no longer overlaps the top bar.",
    updateCanvas: "News text now changes in sync with completed scroll cycles.",
    updateModalNote: "The save format is unchanged from 0.5.0.",
    updateClose: "Close",
    under10ms: "<10 ms",
    secondsUnit: "s",
    millisecondsUnit: "ms",
