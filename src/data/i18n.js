...
const TEXT = {
  ja: {
    ...
    updateTitle: "0.2.2 アップデート",
    updateSummary: "e308付近で動作が止まることがある問題を修正しました。",
    updateResetDock: "初回Infinity直前の高速周回で、処理が重くなりすぎないようにしました。",
    updateCanvas: "初回Infinity到達時に余分なIPを得ない挙動は維持しています。",
  ...
  en: {
    ...
    updateTitle: "Version 0.2.2",
    updateSummary: "Fixed a possible freeze around e308.",
    updateResetDock: "Reduced heavy processing during high-speed laps just before the first Infinity.",
    updateCanvas: "The first Infinity still avoids granting extra post-threshold IP.",
