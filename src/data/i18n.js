...
const TEXT = {
  ja: {
    ...
    updateTitle: "0.2.1 アップデート",
    updateSummary: "GR自動化の条件指定を調整しました。",
    updateResetDock: "GR自動化のスコア改善とコスト改善を倍率(×)で指定できるようにしました。",
    updateCanvas: "GR自動化に「最小経過秒数」を追加しました。",
    updateModalNote: "既存のGR自動化設定はできる限り以前と同じ動作になるように読み込まれます。",
    updateClose: "閉じる",
    under10ms: "10ミリ秒未満",
    secondsUnit: "秒",
  ...
  en: {
    ...
    updateTitle: "Version 0.2.1",
    updateSummary: "Adjusted Generation automation conditions.",
    updateResetDock: "Generation automation score and cost improvements can now be set as multipliers (x).",
    updateCanvas: "Added a minimum elapsed seconds condition for Generation automation.",
    updateModalNote: "Existing Generation automation settings are loaded to stay as close as possible to their previous behavior.",
    updateClose: "Close",
    under10ms: "<10 ms",
    secondsUnit: "s",
    millisecondsUnit: "ms",
