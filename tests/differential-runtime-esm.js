...
async function runDifferentialTests() {
  ...
  await compareScenario("Infinity Challenge 8 active preservation", async ({ debug }) => {
    ...
    approvedBalancePaths: [
      "state.coreBoostCount",
      "state.generationCostFactor",
      "state.generationCount",
      "state.generationScoreMultiplier",
      "state.generationScoreMultiplierLog10",
      "state.previousGenerationScore",
      "state.previousGenerationScoreLog10",
      "state.score",
      "state.scoreLog10",
      "state.totalScore",
      "state.totalScoreLog10",
      ...
      "view.achievements.vertexGainIncrease",
      "view.coreBoost.count",
      "view.coreBoost.gainExponent",
      "view.coreBoost.gainIncreaseMultiplier",
      "view.generation.achievementScoreMultiplier",
      "view.generation.costFactor",
      "view.generation.count",
      "view.generation.previousGenerationScore",
      "view.generation.previousGenerationScoreLog10",
      "view.generation.rawScoreMultiplier",
      "view.generation.rawScoreMultiplierLog10",
      "view.generation.requirement",
      "view.generation.requirementLog10",
      "view.generation.scoreMultiplier",
      "view.generation.scoreMultiplierLog10",
      "view.generation.unlocked",
      "view.lapSpeedSoftcapPower",
      "view.lapSpeedSoftcapStart",
      "view.upgrades.costs.vertex",
      "view.upgrades.costs.vertexLog10",
    ],
  });
