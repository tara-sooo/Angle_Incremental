...
| Edit PR body (branch-aware issue-association fix, D3.5) | Reversible                | Edit again                                                                                                                                                                  | D3, D3.5 (`idd-pr-submit.instructions.md`)                                  |
...
| Delete remote branch (when GitHub auto-delete is disabled)            | Reversible                | Content is preserved via the merge commit on `next`; only runs after a successful merge                                                     | F4 (`idd-merge.instructions.md`) |
| Update local `next`                                                   | Reversible                | Trivial fast-forward re-fetch                                                                                                               | F4 (`idd-merge.instructions.md`) |
