...
const saveFormatSource = fs.readFileSync(path.join(root, "src", "core", "save-format.js"), "utf8");
...
assertNamedImports(eventsSource, "../core/save-format.js", ["clampOfflineTickCount"]);
assertNamedImports(offlineProgressSource, "./save-format.js", ["clampOfflineTickCount"]);
assertNamedImports(saveSource, "./save-format.js", ["clampOfflineTickCount"]);
assert.match(saveFormatSource, /^export function clampOfflineTickCount\(/m);
